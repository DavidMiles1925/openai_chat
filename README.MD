...
- Behind gpt-5-mini and gpt-5 in:
  &emsp - Handling very large contexts.  
  &emsp - Understanding complex, intertwined logic across files.  
  &emsp - Producing fully correct answers on first try for tricky bugs.
